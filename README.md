...
## 0x03: Features
-*Speed: **Compiled C binary for instat results.
-*portability: **Sigle file, no dependecies.
-*PicoCTF Ready: **Designed to handle the integer ranges typically found in entry-to-intermediate CTF challenges.
